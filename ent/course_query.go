...
func (cq *CourseQuery) QuerySubject() *SubjectQuery {
...
func (cq *CourseQuery) QueryProfessor() *ProfessorQuery {
...
func (cq *CourseQuery) Clone() *CourseQuery {
	...
	return &CourseQuery{
		...
		withProfessor: cq.withProfessor.Clone(),
...
func (cq *CourseQuery) WithSubject(opts ...func(*SubjectQuery)) *CourseQuery {
	query := (&SubjectClient{config: cq.config}).Query()
...
func (cq *CourseQuery) WithProfessor(opts ...func(*ProfessorQuery)) *CourseQuery {
	query := (&ProfessorClient{config: cq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	cq.withProfessor = query
	return cq
}
...
func (cq *CourseQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Course, error) {
	...
	if query := cq.withProfessor; query != nil {
		if err := cq.loadProfessor(ctx, query, nodes, nil,
			func(n *Course, e *Professor) { n.Edges.Professor = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CourseQuery) loadProfessor(ctx context.Context, query *ProfessorQuery, nodes []*Course, init func(*Course), assign func(*Course, *Professor)) error {
